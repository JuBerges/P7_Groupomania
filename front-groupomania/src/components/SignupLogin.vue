    ...
    <div class="signuplogin">
        <div id="login" class="h-screen" v-if="!toggleOptions">
            <div id="homeTitle" class="flex w-max mx-auto pt-11">
                <img class="h-11" src="../assets/images/nav-mini-logo.png" alt="logo groupomania" />
            ...
            <div class="text-white text-center">
                ...
                <form class="flex flex-col" @submit="logIn" method="post">
                    <div v-if="errors.length">
                        <b class="my-blue">Merci de corriger le(s) erreur(s) suivante(s):</b>
                        <ul>
                    ...
                    <input id="email" class="mx-auto text-black p-1 placeholder-gray-500" placeholder="E-mail" v-model="email" type="email" />
                    <label class="pt-2" for="password">Mot de passe: </label>
                    <input id="password" class="mx-auto text-black p-1 placeholder-gray-500" placeholder="Mot de passe" v-model="password" type="password" />
                    ...
                    <button class="p my-blue hover:underline mb-6" @click="
              (toggleOptions = true),
        ...
        <div id="signup" v-else>
            ...
            <div class="text-white text-center">
                ...
                <form class="flex flex-col" action="/signup" enctype="multipart/form-data" method="post">
                    <label class="pt-2" for="username">Choisissez votre pseudo: </label>
                    <input id="username" class="mx-auto text-black p-1 placeholder-gray-500" placeholder="Pseudo" type="text" v-model="username" />
                    <p class="text-gray-400 text-xs pt-2">
                        Utilisez uniquement des chiffres<br />
                        et des lettres sans espace.
                    </p>
                    <label class="pt-2" for="email">E-mail: </label>
                    <input id="email" class="mx-auto text-black p-1 placeholder-gray-500" placeholder="Adresse e-mail" type="email" v-model="email" />
                    <label class="pt-2" for="password">Mot de passe: </label>
                    <input id="password" class="mx-auto text-black p-1 placeholder-gray-500" placeholder="Votre mot de passe" type="password" v-model="password" /><input id="password" class="mx-auto text-black p-1 placeholder-gray-500 mt-1" placeholder="Retapez votre mot de passe" type="password" v-model="passwordCheck" />
                    <p class="text-gray-400 text-xs pt-2">
                    ...
                    <div v-if="file" class="w-20 h-20 rounded-full mx-auto cursor-pointer preview" :style="{ 'background-image': `url(${file})` }" @click="chooseImage"></div>
                    <the-button class="mt-6 mx-auto" type="submit" @click.prevent="signUp">
                        <template v-slot:label>S'inscrire</template>
                    </the-button>
                    <p class="pt-4">Déjà membre ?</p>
                    <button class="p my-blue hover:underline pb-11" @click="(toggleOptions = false), (username = null)">
                        Se connecter
                    </button>
                </form>
            </div>
